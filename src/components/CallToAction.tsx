        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="animate-fade-in">
            ...
            <p className="text-xl mb-12 opacity-90 max-w-2xl mx-auto">
              Ready to explore Albania's stunning landscapes, rich history, and warm hospitality? 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all">
                ...
                <p className="text-sm opacity-90">Custom itineraries for every traveler</p>
              </div>

              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all">
                <Calendar className="w-10 h-10 mx-auto mb-4" />
                <h3 className="text-xl font-bold mb-2">Plan Ahead</h3>
                <p className="text-sm opacity-90">Book accommodations and experiences</p>
              </div>

              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all">
                <Plane className="w-10 h-10 mx-auto mb-4" />
                <h3 className="text-xl font-bold mb-2">Travel Tips</h3>
                <p className="text-sm opacity-90">Local insights and recommendations</p>
              </div>
            </div>
