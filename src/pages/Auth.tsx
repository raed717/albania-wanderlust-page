...
export default function AuthPage() {
  ...
  const handleManualSignUp = async (e: propsHedear) => {
    ...
    setTimeout(() => {
      console.log('Sign up with email:', email, 'Name:', name);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={isSignUp ? handleManualSignUp : handleManualSignIn}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors font-semibold mb-4"
            >
