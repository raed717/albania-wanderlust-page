...
import { getCurrentUserWishlist, removeDestinationFromCurrentUserWishlist } from "@/services/api/destinationService";
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-muted-foreground animate-pulse">Finding your favorites...</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-slate-50/50">
            ...
            <main className="container mx-auto px-4 py-12">
                <header className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
                    <div>
                        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">Saved for later</h1>
                        <p className="text-muted-foreground mt-2">
                            You have {wishlist?.destinations.length || 0} destinations saved in your wishlist.
                        </p>
                    </div>
                </header>
                ...
                {!wishlist || wishlist.destinations.length === 0 ? (
                    <div className="text-center py-24 bg-white rounded-2xl border-2 border-dashed border-slate-200">
                        ...
                        <p className="text-muted-foreground mb-8 max-w-xs mx-auto">
                            Start exploring the world and save your favorite spots for your next adventure.
                        </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {wishlist.destinations.map((destination) => (
                            <Card key={destination.id} className="group overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
                                {/* Image Container */}
